...
Restored the Feynman quote above centered social links. Removed the forced full-viewport-height flex shell so the page ends naturally after its content. Reduced stacked spacing after the last homepage essay and limited footer bottom padding to 20px or the device safe area.
